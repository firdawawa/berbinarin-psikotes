...
<body>
    <div class="flex">   
        <div class="w-2/5 mx-auto text-center">
            ...
            <div class="mt-10">
                <input type="email" placeholder="Email" class="border-2 h-12 w-[208px] rounded-lg p-4">
                <input type="text" placeholder="Company Name" class="border-2 h-12 w-[208px] rounded-lg p-4">
                <input type="number" placeholder="Company Telp. Number" class="border-2 h-12 w-[420px] rounded-lg p-4 mt-5">
        ...
        <div class="flex w-3/5 bg-primary">
            <img src="{{ asset('assets/images/ilustrasi_compreg.png') }}" alt="Ilustrasi-Test" class="m-auto w-[1000px]">
        </div>
    </div>
</body>
</html>